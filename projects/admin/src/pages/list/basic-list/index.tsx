...
import { Avatar, Button, Card, Col, Dropdown, Input, List, Modal, Progress, Row, Segmented } from 'antd'
  ...
  const extraContent = (
    <div>
      <Segmented
        ...
        // 如有需要可添加 onChange 事件
      />
      <Search className={styles.extraContentSearch} placeholder="请输入" onSearch={() => ({})} variant="filled" />
    </div>
  )
